  ...
  useEffect(() => {
    ...
    const loadModerators = async () => {
      ...
      try {
        ...
        setMessage(
          error instanceof Error ? error.message : 'Failed to load moderators',
        )
      } finally {
        setLoading(false)
      }
  ...
  const handleRemoveModerator = async (moderatorId: string) => {
    ...
    try {
      const response = await adminFetch(
        apiUrl(`/api/admin/moderators/${moderatorId}`),
        {
          method: 'DELETE',
        },
      )
      ...
      setMessage(
        error instanceof Error ? error.message : 'Error removing moderator',
      )
    } finally {
          ...
          <div className='split' style={{ marginTop: 18 }}>
            <div className='stack-tight'>
              <div className='card'>
                ...
                <p
                  className='muted'
                  style={{ marginTop: 12, fontSize: '0.9em' }}
                >
                  <strong>Moderators cannot:</strong> Manage users, change
                  roles, view private user posts (only admin-marked private), or
            ...
            <div className='stack-tight'>
              <div className='card'>
                ...
                {loading ? (
                  ...
                  <p className='muted'>
                    No moderators assigned yet. Use the User Management page to
                    promote users.
                  </p>
                ) : (
